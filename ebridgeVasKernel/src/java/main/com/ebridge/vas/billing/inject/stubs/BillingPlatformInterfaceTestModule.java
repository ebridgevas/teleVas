 ...
 */
public class BillingPlatformInterfaceTestModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(ServiceSoap.class).annotatedWith(Names.named("prepaidServiceSoapProvider"))
                .toProvider(PrepaidPlatformServiceSoapStubProvider.class);

        bind(WebServices.class).annotatedWith(Names.named("postpaidServiceSoapProvider"))
                .toProvider(PostpaidPlatformServiceSoapStubProvider.class);
