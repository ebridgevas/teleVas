...
import com.ebridge.protocol.smpp.TimeoutException;
...
public class Unprocessed
{
    ...
    *
    * @see #hasUnprocessed
    * @see com.logica.smpp.ReceiverBase#receivePDUFromConnection(Connection, com.ebridge.protocol.smpp.util.Unprocessed)
    */
