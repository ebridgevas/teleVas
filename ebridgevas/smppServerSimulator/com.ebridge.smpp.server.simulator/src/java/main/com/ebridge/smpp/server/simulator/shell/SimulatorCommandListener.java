...
import com.ebridge.smpp.server.simulator.shell.Binding;
import com.ebridge.smpp.server.simulator.shell.Command;
import com.ebridge.smpp.server.simulator.shell.Shell;
...
public class SimulatorCommandListener implements Runnable, Binding {
    ...
    public SimulatorCommandListener(Command command, ServerSocket socket, int maxConnections) {
        m_command = command;
        m_socket = socket;
